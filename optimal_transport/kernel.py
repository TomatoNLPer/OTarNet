...
from my_OTK.my_utils import spherical_kmeans, normalize
from my_OTK.my_sinkhorn import wasserstein_kmeans, multihead_attn
...
class OTKernel(nn.Module):
    ...
    def get_attn(self, input,target, mask=None, position_filter=None):
    ...
    def forward(self, input,target, mask=None):
        ...
        attn_weight = self.get_attn(input,target, mask, position_filter)
